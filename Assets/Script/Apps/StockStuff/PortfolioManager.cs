...
public class PortfolioManager : MonoBehaviour
{
    ...
    [SerializeField] public List<Holding> holdings = new List<Holding>();
    ...
    // Add a holding (used during load)
    public void AddHolding(StockData stock, int shares, float totalInvested)
    {
